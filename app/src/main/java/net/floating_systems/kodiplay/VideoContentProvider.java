    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        if(uri.toString().contains("/search")) {
            ...
            if(db == null){
                ...
                mc.addRow(new Object[]{0,"Kodi Database not found", "Please check or disable this App" });
            ...
            cursor = db.rawQuery("SELECT "
                    ...
                    + ", c05 AS " + Constants.KODI_COLUMN_RATING
...
//                String moviePath = cursor.getString(cursor.getColumnIndex(Constants.COLUMN_PATH));
                ...
                String movieInfo = getContext().getString(R.string.year) + ": " + cursor.getString(cursor.getColumnIndex(SearchManager.SUGGEST_COLUMN_PRODUCTION_YEAR))
                                    + "\n"+getContext().getString(R.string.rating)+": "
                                    + Math.round(cursor.getDouble(cursor.getColumnIndex(Constants.KODI_COLUMN_RATING)) * 10f) / 10f +"/10";

            //Idea: Add more infos in next line: + "\n" + "Steven Spielberg"
                ...
                if(moviePoster == null || moviePoster.trim().equals("")) {
                    moviePoster = getPoster(movieIMDB);
                }


                mc.addRow(new Object[]{movieId, movieId, movieText, movieInfo, moviePoster, moviePath});
...
*/
            ...
            Date fetchHighRatingMinYear = new Date(System.currentTimeMillis());
            Format formatterYear = new SimpleDateFormat("yyyy");
            int currentYear = Integer.parseInt(formatterYear.format(fetchHighRatingMinYear));
