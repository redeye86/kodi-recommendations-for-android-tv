...
public class UpdateRecommendationsService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Cursor recommendationsCursor = getContentResolver().query(Uri.parse("content://net.floating_systems.kodiplay.VideoContentProvider/recommendations"), null, null, null, null);
